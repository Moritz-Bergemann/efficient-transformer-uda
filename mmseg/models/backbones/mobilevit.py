...
class LayerScale(nn.Module):
    ...
    Retrieved from https://github.com/open-mmlab/mmclassification/blob/ce3fa7b3fba9a4ad4db63e7e1afc6da80325cdee/mmcls/models/utils/layer_scale.py#L1
    """
...
class MultiheadAttention(BaseModule):
    ...
    Args:
        ...
        init_cfg (dict, optional): The Config for initialization.
            Defaults to None.
    Retrieved from https://github.com/open-mmlab/mmclassification/blob/ce3fa7b3fba9a4ad4db63e7e1afc6da80325cdee/mmcls/models/utils/attention.py#L1
    """
...
class TransformerEncoderLayer(BaseModule):
    ...
    Args:
        ...
        init_cfg (dict, optional): Initialization config dict.
            Defaults to None.
    Retrieved from https://github.com/open-mmlab/mmclassification/blob/ce3fa7b3fba9a4ad4db63e7e1afc6da80325cdee/mmcls/models/backbones/vision_transformer.py
    """
...
class MobileViT(BaseModule):
    ...
    arch_settings = {
        'small': [
            ...
            ['mobilevit', 160, 1, 240, 480, 3, 4],  # MODIFIED FOR SEGMENTATION: Final Stride is 1, not 2
        ],
        'x_small': [
            ['mobilenetv2', 32, 1, 1, 4],
            ...
            ['mobilevit', 96, 1, 144, 288, 3, 4],  # As above
        ],
        'xx_small': [
            ...
            ['mobilevit', 80, 1, 96, 192, 3, 2],  # As above
        ]
    }
