...
_base_ = [
    ...
    "../_base_/models/mobilevit_xx_small.py",
...
name = 'gta2cs_uda_warm_fdthings_rcs_croppl_a999_mobilevit_xx_small'
exp = 'uda'
name_dataset = 'gta2cityscapes'
name_architecture = 'mobilevit_xx_small'
name_encoder = 'mobilevit_xx_small'
